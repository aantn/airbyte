...
import pytest
from source_orbit_love.source import OrbitLoveStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(OrbitLoveStream, "path", "v0/example_endpoint")
    mocker.patch.object(OrbitLoveStream, "primary_key", "test_primary_key")
    mocker.patch.object(OrbitLoveStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = OrbitLoveStream()
